...
class Policy(models.Model):
    ...
    plcyPvsnMthdCd = models.CharField(max_length=10, choices=POLICY_PROVISION_METHOD_CHOICES, null=True, blank=True) # 정책제공방법코드
    ...
    inqCnt = models.CharField(max_length=20, null=True, blank=True)  # 조회수
    ...
    jobCd = models.CharField(max_length=10, choices=JOB_CHOICES, null=True, blank=True)  # 취업 요건 코드
    schoolCd = models.CharField(max_length=10, choices=SCHOOL_CHOICES, null=True, blank=True)  # 학력 요건 코드
    ...
    sbizCd = models.CharField(max_length=10, choices=SBIZ_CHOICES, null=True, blank=True)  # 정책 특화 요건 코드
